...
import com.cgbsoft.lib.utils.dm.core.enums.QueueSort;
import com.cgbsoft.lib.utils.dm.core.enums.TaskStates;
import com.cgbsoft.lib.utils.dm.core.mainWorker.AsyncStartDownload;
import com.cgbsoft.lib.utils.dm.core.mainWorker.QueueModerator;
import com.cgbsoft.lib.utils.dm.database.ChunksDataSource;
import com.cgbsoft.lib.utils.dm.database.DatabaseHelper;
...
import com.cgbsoft.lib.utils.dm.report.ReportStructure;
import com.cgbsoft.lib.utils.dm.report.exceptions.QueueDownloadInProgressException;
import com.cgbsoft.lib.utils.dm.report.exceptions.QueueDownloadNotStartedException;
...
//        dbHelper.close();
    ...
    public Task getTask(int token){
        return tasksDataSource.getTaskInfo(token);
    }
